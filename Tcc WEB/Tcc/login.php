  ...
  <div class="bodyDISC">
    <div class="d-flex justify-content-center">
      <div class="containerDISC">
        ...
        <form class="formDISC" id="form" method="post" action="backend/autenticarUsuario.php">

          <?php if (isset($_SESSION["mensagem-de-login"])) : ?>
            <div class="alert alert-danger" role="alert">
              <?php echo $_SESSION["mensagem-de-login"]; ?>
              <?php unset($_SESSION["mensagem-de-login"]); ?>
            </div>
          <?php endif; ?>
